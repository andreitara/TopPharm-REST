...
import md.pharm.external.taskSubmitted.TaskSubmittedTrigger;
import md.pharm.external.taskSubmitted.TaskSubmittedUtil;
...
public class TopPharmResTfulServiceApplication extends WebMvcConfigurationSupport {
    ...
    public static void main(String[] args) {
        ...
        TaskSubmittedUtil.startTrigger("0 0 18 * * ?");
