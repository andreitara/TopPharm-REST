...
public class GeneralTypeControllerTest {
    ...
    public static void createDoctorByAdmin() throws JsonProcessingException {
        ...
        HttpEntity<Response> response = restTemplate.exchange(StaticStrings.CREATE_GENERAL_TYPE_URI, HttpMethod.POST, entity, Response.class);
    ...
    public static void updateDoctorByAdmin(int id) throws JsonProcessingException {
        speciality.setId(id);
        speciality.setName("Genral Type Update");
        RestTemplate restTemplate = new RestTemplate();
        HttpHeaders headers = new HttpHeaders();
        headers.set("auth-token", StaticStrings.ADMIN_AUTH_TOKEN);
        HttpEntity entity = new HttpEntity(speciality, headers);
        HttpEntity<Response> response = restTemplate.exchange(StaticStrings.UPDATE_GENERAL_TYPE_URI, HttpMethod.POST, entity, Response.class);
        ObjectMapper mapper = new ObjectMapper();
        System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(response.getBody()));
    }
    ...
    public static void getAllDoctorsByAdmin() throws JsonProcessingException {
        ...
        HttpEntity<Response> response = restTemplate.exchange(StaticStrings.GET_ALL_GENERAL_TYPE_URI, HttpMethod.GET, entity, Response.class);
        ObjectMapper mapper = new ObjectMapper();
        System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(response.getBody()));
    }
    ...
    public static void getDoctorByAdmin(int id) throws JsonProcessingException {
        ...
        HttpEntity<Response> response = restTemplate.exchange(StaticStrings.GET_GENERAL_TYPE_URI, HttpMethod.GET, entity, Response.class, params);
        ObjectMapper mapper = new ObjectMapper();
        System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(response.getBody()));
    }
    ...
    public static void deleteDoctorByAdmin(int id) throws JsonProcessingException {
        ...
        Map<String,String> params = new HashMap<>();
        params.put("id",String.valueOf(id));
        HttpEntity<Response> response = restTemplate.exchange(StaticStrings.DELETE_GENERAL_TYPE_URI, HttpMethod.DELETE, entity, Response.class, params);
        ObjectMapper mapper = new ObjectMapper();
        System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(response.getBody()));
    }
